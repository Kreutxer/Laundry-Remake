    ...
    <div class="i-container">
        ...
        <div class="right">
            ...
            <div class="right-content">
                <div class="right-box">
                    <div class="box-title"><p id="title">Tambah Laundry</p></div>
                    <br>
                    <div class="wrapper-add" id="second-add">
                        <div class="wrap-content" id="add-pel">
                            <form action="action-addLndry.php" method="POST">
                                <div class="box">
                                    <label for="harga">Harga</label>
                                    <input type="text" name="harga" id="add">
                                </div>
                                <div class="box">
                                    <label for="jenis_laundry">Jenis Laundry</label>
                                    <input type="text" name="jenis_laundry" id="add">
                                </div>
                                <br>
                                    <div class="save">
